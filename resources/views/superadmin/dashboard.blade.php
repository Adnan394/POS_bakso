                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-style-none mb-0">
                            <li>
                                ...
                                <span class="text-muted">Outlet Depan Purbalingga</span>
                                <span class="text-dark float-right font-weight-medium">Rp.{{ $revenue_outlet_depan_today }}</span>
                            </li>
                            <li class="mt-3">
                                <i class="fas fa-circle text-danger font-10 mr-2"></i>
                                <span class="text-muted">Outlet Belakang Purbalingga</span>
...
<script>
    $(function() {
        c3.generate({
            ...
            data: {
                columns: [
                    ["Outlet Depan Purbalingga", {{ $revenue_outlet_depan_today }}],
                    ["Outlet Belakang Purbalingga", {{  $revenue_outlet_belakang_today }}],
                ],
                type: "donut",
                tooltip: {
                    show: !0
